...
const inputRotation = document.querySelector("#inputRotation");

const box = document.querySelector("[data-js='box']");
// example.addEventListener("input", (evt) => {
//   console.log("VALUE: ", evt.target);

inputColor.addEventListener("input", (evt) => {
    const val = evt.target.value;
    // box.style.backgroundColor = "hsl(" + val + "50% 50%)";
    box.style.backgroundColor = `hsl(${val}, 50%, 50%)`;
...
inputRotation.addEventListener("input", (evt) => {
