    ...
    <div class="product__body">
      <div class="product__text-container">
        ...
        <p class="product__description">
          Anemonefish are omnivorous and can feed on undigested food from their
          host anemones. When a sea anemone is not available in an aquarium, the
          anemonefish may settle in some varieties of soft corals, or large
          polyp stony corals.
        </p>
      </div>
...
const secondButton = document.querySelector('body > article:nth-child(4) > footer > button')
