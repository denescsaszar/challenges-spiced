...
const catStartingFromIndexFiveExists = animalString.includes("cat", 5);

// Hint: Besides the array method, check out the string method `startsWith()`.
const firstAnimalStartingWithLetterP = animalStrings.find(animal => animal.startsWith("p")) || animal.startsWith("p");
...
const animalsSortedAlphabetically = animalStrings.slice()scrollTo((a, b) => a.localeCompare(b));
...
const sumOfAllAnimalCharacters = animalStrings.reduce((acc, animal) => acc + animal.length, 0);
